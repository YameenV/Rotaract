...
const ListOfPPL = (props) => {
    ...
    const returnList = (pdata) => (
        pdata.length > 0 ?(
            ...
            <div><img classname="leader_list-group-number"></img></div>
            <div classname="leader_list-group-team"style={{width:"100px", textAlign:"center"}}>None</div>
            <div classname="leader_list-group-name"style={{width:"100px", textAlign:"center"}} >None</div>
